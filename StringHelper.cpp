...
std::string CStringHelper::SimplifyString( std::string_view oInputString )
{
...
std::string CStringHelper::Replace( std::string_view oInputString, const char cOld, const char cNew )
{
...
// std::string CStringHelper::Replace
// 3BGO JIRA-238 02-10-2020
std::string CStringHelper::Replace( std::string_view oInputString, std::string_view oOldString, std::string_view oNewString )
{
	std::string oResultString{ oInputString };
...
// 3BGO JIRA-238 02-10-2020
std::vector<std::string> CStringHelper::SplitLines( std::string_view oInputString )
{
